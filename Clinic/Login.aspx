<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Clinic.Login" %>
        ...
        <div class="row">
            <div class="col-md-4 mx-auto">
                ...
                <div class="position-absolute start-50">
                    ...
                    <asp:button text="Ingresar" ID="btnIngresar" CssClass="btn btn-lg btn-primary" runat="server" OnClick="btnIngresar_Click" />
                </div>
            </div>
        </div>
    </div>
